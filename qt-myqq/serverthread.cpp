...
void ServerThread::respondLogin()
{
    ...
    if (!query.isNull(QString("acount")) && (tokens[2] == query.value(1).toString())) {
        respond(QString("0 1 %1 %2").arg(query.value(2).toString()).arg(query.value(3).toString()));
...
void ServerThread::respondLoggedin()
{
    ...
    if (query.isNull(QString("acount"))) {
        ...
        respond(QString("11 1 %1 %2").arg(query.value(2).toString()).arg(query.value(3).toString()));
    }
    qDebug() << "addFriend";
